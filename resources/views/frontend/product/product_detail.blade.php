        ...
        <div class="card">
            <div class="product">
                <div class="product-img">
                    ...
                    @for ($i = 0; $i < count($arr_image) - 1; $i++) @php $image=$arr_image[$i]['image']; @endphp <img
                        class="" src="{{ asset('images/product/' . $image) }}" onclick="myFunction(this)">
                        @endfor
                        @endif
                </div>
                ...
                <div class="box">
                    ...
                    <article class="media mb-3">
                        ...
                        <div class="media-body">
                            <h6 class="mt-0"><a href="{{ route('frontend.slug', ['slug' => $item->slug]) }}">{{
                                    $item->name }}</a>
                            </h6>
