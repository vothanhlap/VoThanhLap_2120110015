                                ...
                                <div class="card">
                                    <div class="card-header" id="headingmenu">
                                        ...
                                        <span class="float-right btn btn-sm btn-info" data-toggle="collapse"
                                            data-target="#collapsemenu" aria-expanded="true"
                                            aria-controls="collapsemenu">
                                            <i class="fas fa-plus"></i>
                                        </span>
                                    </div>
                                    <div id="collapsemenu" class="collapse p-2 m-2" aria-labelledby="headingmenu"
                                        data-parent="#accordionExample">
                                        @foreach ($list_menu as $menu)
                                        <fieldset class="form-group">
                                            <input name="namemenu[]" value="{{$menu->name}}" id="{{$menu->id}}" type="checkbox">
                                            <label for="">{{$menu->name}}</label>
                                        </fieldset>
                                        @endforeach
                                        <fieldset class="form-group">
                                            <input type="submit" name="Themmenu" value="Thêm"
